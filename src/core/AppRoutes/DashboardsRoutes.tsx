...
const HealthCare = React.lazy(() => import('src/modules/dashboards/HealthCare'))
const ECommerce = React.lazy(() => import('src/modules/dashboards/ECommerce'))
const CRM = React.lazy(() => import('src/modules/dashboards/CRM'))
const Crypto = React.lazy(() => import('src/modules/dashboards/Crypto'))
const Analytics = React.lazy(() => import('src/modules/dashboards/Analytics'))
