...
const Error401 = React.lazy(
  () => import("src/modules/errorPages/Error401"),
);
const Error403 = React.lazy(
  () => import("src/modules/errorPages/Error403"),
);
const Error404 = React.lazy(
  () => import("src/modules/errorPages/Error404"),
);
const Error500 = React.lazy(
  () => import("src/modules/errorPages/Error500"),
);
const Error503 = React.lazy(
  () => import("src/modules/errorPages/Error503"),
);
const ComingSoon = React.lazy(
  () => import("src/modules/errorPages/ComingSoon"),
);
const Maintenance = React.lazy(
  () => import("src/modules/errorPages/Maintenance"),
);
