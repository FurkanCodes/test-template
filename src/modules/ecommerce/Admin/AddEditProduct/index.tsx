...
import { postDataApi, putDataApi } from 'src/hooks/APIHooks';
import { useNavigate } from 'react-router-dom';
import { getStringFromHtml } from 'src/helpers/StringHelper';
import {
  FileType,
  ProductDataType,
  ProductInfoType,
  TagType,
} from 'src/types/models/ecommerce/EcommerceApp';
