...
import UploadModern from 'src/thirdParty/reactDropzone/components/UploadModern';
import PreviewThumb from 'src/thirdParty/reactDropzone/components/PreviewThumb';
import { FileType } from 'src/types/models/ecommerce/EcommerceApp';
