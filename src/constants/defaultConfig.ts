...
export const defaultTheme: any = {
  theme: {
    ...
    palette: {
      ...
      grayOpacity: {
        50: 'rgba(250, 250, 250, 0.5)', // 50% opacity
        100: 'rgba(245, 246, 250, 0.5)', // 50% opacity
        200: 'rgba(237, 242, 247, 0.5)', // 50% opacity
        300: 'rgba(224, 224, 224, 0.5)', // 50% opacity
        400: 'rgba(209, 210, 213, 0.5)', // 50% opacity
        500: 'rgba(168, 168, 168, 0.5)', // 50% opacity
        600: 'rgba(102, 102, 102, 0.5)', // 50% opacity
        700: 'rgba(74, 85, 104, 0.5)', // 50% opacity
        800: 'rgba(32, 26, 33, 0.6)', // 50% opacity
        900: 'rgba(26, 32, 44, 0.5)', // 50% opacity
        A100: 'rgba(213, 213, 213, 0.5)', // 50% opacity
        A200: 'rgba(170, 170, 170, 0.5)', // 50% opacity
        A400: 'rgba(112, 112, 112, 0.5)', // 50% opacity
        A700: 'rgba(97, 97, 97, 0.5)', // 50% opacity
      },
    },
    status: {
      danger: 'orange',
